...
\begin{document}
  \begin{tikzpicture}
    \node[circle, draw, fill=red, minimum size = 0.9cm] (c) at (0,0){$m_1$}; 
    ...
    \draw (-2,0) arc [start angle=180, end angle=215, x radius=2cm, y radius =2cm] node[midway,fill=white] {$\theta$};
  \end{tikzpicture}
\end{document}